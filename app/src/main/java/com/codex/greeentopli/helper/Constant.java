...
public class Constant {
    //MODIFICATION PART
    public static final String MAINBASEUrl = "https://greentopli10.codextechnologies.co.in/"; //Admin panel url

    //If you have eCart Website then place here website URL otherwise admin panel url
    public static final String WebsiteUrl = "https://greentopli10.codextechnologies.co.in/";
